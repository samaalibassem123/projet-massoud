...
-- reset staging area
delete from StagingArea.dbo.stag_EmploiPerSecteur
delete from StagingArea.dbo.stag_EmploiPerAge
delete from StagingArea.dbo.stag_Migration
delete from StagingArea.dbo.stag_Education


-- Reset Identity for StagingArea tables
DBCC CHECKIDENT ('StagingArea.dbo.stag_EmploiPerSecteur', RESEED, 0);
DBCC CHECKIDENT ('StagingArea.dbo.stag_EmploiPerAge', RESEED, 0);
DBCC CHECKIDENT ('StagingArea.dbo.stag_Migration', RESEED, 0);
